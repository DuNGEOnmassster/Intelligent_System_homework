...
import Greedy
from common import GetData,ResultShow,draw,Node
...
if __name__ == "__main__":
	Position,CityNum,Dist = GetData("./data/TSP20cities.tsp")
	...
	print()
	ResultShow(Min_Path,BestPath,CityNum,"分支定界法")
